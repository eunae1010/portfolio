...
<main class="maincss" id="airNewcode">
    <section>
	    <p>항공 코드 등록 페이지</p>
    	<form id="f">
	        ...
	        <div class="cate_insert">
	            <ul>
	                <li>공항코드</li>
	                <li><input type="text" :name="data1" class="cate_input1" style="margin-right: 10px;"></li>
	                <li>※ 공항코드는 무조건 대문자로 입력되도록 합니다.</li>
	            </ul>
	            <ul>
	                <li>항공사명</li>
	                <li><input type="text" :name="data2" class="cate_input3" style="margin-right: 10px;"></li>
	                <li>※ 항공사명은 특수문자는 입력되지 않습니다.</li>
	            </ul>
	            <ul>
	                <li>항공코드</li>
	                <li>
	                	<input type="text" :name="data3" class="cate_input3" style="margin-right: 10px;"> <input type="button" value="중복확인" title="중복확인" class="product_btn" @click="codeck()">
	                </li>
	            ...
	            <ul>
	                <li>항공편명</li>
	                <li>
	                    <input type="text" :name="data4" class="cate_input3" list="lg_menu">
	                </li>
	            ...
	            <ul>
	                <li>사용 유/무</li>
	                <li>
	                    <label class="rmargin"><input type="radio" :name="data5" value="Y" checked>사용함</label>
	                    <label class="rmargin"><input type="radio" :name="data5" value="N">사용안함</label>
	                </li>
...
<script src="./js/air_newcode.js?v=<%=today%>"></script>
</html>