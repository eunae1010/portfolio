...
<!-- FAQ 등록 시작 -->
<main class="maincss" id="faqModify">
	<section class="page_section">
		<p>FAQ 확인 및 수정</p>
		<div class="listbody">
			<div class="procho">
				<form id="f">
					<input type="hidden" name="fidx" value="${view.get(0)}">
					<section class="data_listsview">
						<ol>
							<li>질문 제목</li>
							<li><input type="text" name="fsubject" value="${view.get(1)}" class="notice_in in1"></li>
							<li>글쓴이</li>
							<li><input type="text" name="fwriter" value="${view.get(2)}" class="notice_in in2" readonly></li>
							<li style="height:520px;">질문 내용</li>
							<li style="height:520px; padding-top: 10px; padding-left: 10px;">
								<textarea class="notice_in in3" name="ftext" id="boardtext">${view.get(3)}</textarea>
							</li>      
						</ol>
						<span class="notice_btns">
							<input type="button" value="FAQ 리스트" class="meno_btn1" @click="faq_list()">
							<input type="button" value="FAQ 수정" class="meno_btn2" @click="faq_modify()">
						</span>
					</section>
				</form>
			</div>
